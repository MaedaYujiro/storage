...
### Solver
my %solver = ();
$solver{"mds-basic"} = "gtime -v gtimeout $timeout ./target/release/maxmin mds-basic";
$solver{"mds-trans"} = "gtime -v gtimeout $timeout ./target/release/maxmin mds-trans";
$solver{"mis-basic"} = "gtime -v gtimeout $timeout ./target/release/maxmin mis-basic";
$solver{"mis-trans"} = "gtime -v gtimeout $timeout ./target/release/maxmin mis-trans";
