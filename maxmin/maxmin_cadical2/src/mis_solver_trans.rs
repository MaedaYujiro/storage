use cp4rust::{CSP, Bool, Constraint, CaDiCaLSolver, Encoder};
...
impl MisSolverTrans {
    ...
    pub fn enumerate_maximal(&self) -> (Vec<Vec<usize>>, (i32, i32), (i32, i32)) {
        ...
        // Count CSP constraints
        let mut csp_clause_count = 0;
        ...
        // Original CSP statistics - IS constraints only
        // (Maximality constraints are handled by encoder, not counted in orig_clauses)
