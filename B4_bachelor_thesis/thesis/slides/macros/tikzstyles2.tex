...
\usetikzlibrary{arrows,shapes,shadows,scopes,arrows.meta}
...
\colorlet{colorhb}{red}
%\colorlet{colorhc}{ForestGreen}
...
\tikzstyle{current process}=[process,fill=lightcyan] %State
\tikzstyle{fix process}=[process,fill=red!20] %fix State
...
\tikzstyle{active local transition}=[->,>=latex',hl,bend left=30,
every node/.style={fill=white,inner sep=1pt,outer sep=1pt}]

\tikzstyle{blocked local transition}=[->,>=latex',hb,thick,bend left=30,
every node/.style={fill=white,inner sep=1pt,outer sep=1pt}]

\tikzstyle{current local transition}=[->,>=latex',hc,thick,bend left=30,
every node/.style={fill=white,inner sep=1pt,outer sep=1pt}]
...
\tikzstyle{etiquetteErr}=[midway,fill=red!20,circle,scale=0.7pt]

%
\tikzstyle{activatedTrans}=[->,very thick,blue]
\tikzstyle{currentTrans}=[->,very thick,green]
\tikzstyle{seperatedTransPart1}=[draw, thick, green]
\tikzstyle{seperatedTransPart2}=[->, thick, green]
