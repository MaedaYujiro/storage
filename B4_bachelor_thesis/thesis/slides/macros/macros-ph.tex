...
\newcommand{\TStateFix}[1]{
  \foreach \proc in {#1} {
        \node[fix process] (\proc) at (\proc.center) {};
  };
}
...
% AN transition
%$\tau_1 = b_0 \underset{2}{\overset{\{a_1\}}{\longrightarrow}} b_1$, 
\newcommand{\trans}[4]{
#1 \underset{#2}{\overset{\{#3\}}{\longrightarrow}} #4
}
\newcommand{\transEmpty}[4]{
#1 \underset{#2}{\overset{#3}{\longrightarrow}} #4
}
%\newcommand{\trans}[3]{
